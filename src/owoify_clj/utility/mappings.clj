...
(def nr-to-nw-lower #"([Nn])r")
(def mem-to-mwem-upper #"Mem")
(def mem-to-mwem-lower #"mem")
(def nywo-to-nyo #"([Nn])ywo")
(def fuc-to-fwuc #"([Ff])uc")
(def mom-to-mwom #"([Mm])om")
(def me-to-mwe-upper #"^Me$")
(def me-to-mwe-lower #"^me$")
...
(def great-to-gwate #"([Gg])reat")
(def aviat-to-awiat #"([Aa])viat")
(def dedicat-to-deditat #"([Dd])edicat")
(def remember-to-rember #"([Rr])emember")
(def when-to-wen #"([Ww])hen")
(def frightened-to-frigten #"([Ff])righten(ed)*")
(def meme-to-mem-first #"Meme")
(def meme-to-mem-second #"Mem")
(def feel-to-fell #"^([Ff])eel$")
...
(defn map-nr-to-nw [input] (-> (word/replace input nr-to-nw-lower "$1w")
                               (word/replace nr-to-nw-upper "NW")))
(defn map-mem-to-mwem [input] (-> (word/replace input mem-to-mwem-upper "mwem")
                                  (word/replace mem-to-mwem-lower "Mwem")))
(defn unmap-nywo-to-nyo [input] (word/replace input nywo-to-nyo "$1yo"))
...
(defn map-me-to-mwe [input] (-> (word/replace input me-to-mwe-upper "Mwe")
                                (word/replace me-to-mwe-lower "mwe")))
...
(defn map-great-to-gwate [input] (word/replace input great-to-gwate "$1wate"))
(defn map-aviat-to-awiat [input] (word/replace input aviat-to-awiat "$1wiat"))
(defn map-dedicat-to-deditat [input] (word/replace input dedicat-to-deditat "$1editat"))
(defn map-remember-to-rember [input] (word/replace input remember-to-rember "$1ember"))
(defn map-when-to-wen [input] (word/replace input when-to-wen "$1en"))
(defn map-frightened-to-frigten [input] (word/replace input frightened-to-frigten "$1rigten"))
(defn map-meme-to-mem [input] (-> (word/replace input meme-to-mem-first "mem")
                                  (word/replace meme-to-mem-second "Mem")))
(defn map-feel-to-fell [input] (word/replace input feel-to-fell "$1ell"))